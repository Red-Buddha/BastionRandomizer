...
namespace WindowsFormsApp1
{
    class Randomizer
    {
        public void Init()
        {
            levelInfos.Add(new LevelInfo("ProtoIntro01b", "GUI\\Shell\\level_icons\\map_protointro01b", "Menu_21", "ProtoIntro01b_Completed", 0));
            levelInfos.Add(new LevelInfo("ProtoTown03", "GUI\\Shell\\level_icons\\map_prototown01", "ProtoTown03_154", "", 0));
            levelInfos.Add(new LevelInfo("Crossroads01", "GUI\\Shell\\level_icons\\map_crossroads01", "Menu_33", "Crossroads01_Completed", 99));
            levelInfos.Add(new LevelInfo("Challenge01", "GUI\\Shell\\level_icons\\map_challenge01", "Menu_26", "Challenge01_Completed", 99));
            levelInfos.Add(new LevelInfo("Holdout01", "GUI\\Shell\\level_icons\\map_holdout01", "Menu_31", "Holdout01_Completed", 99));
            levelInfos.Add(new LevelInfo("Falling01", "GUI\\Shell\\level_icons\\map_falling01", "Menu_22", "Falling01_Completed", 99));
            levelInfos.Add(new LevelInfo("Challenge03", "GUI\\Shell\\level_icons\\map_challenge03", "Challenge03_24", "Challenge03_Completed", 99));
            levelInfos.Add(new LevelInfo("Challenge06", "GUI\\Shell\\level_icons\\map_challenge06", "Challenge06_18", "Challenge06_Completed", 99));
            levelInfos.Add(new LevelInfo("Survivor01", "GUI\\Shell\\level_icons\\map_survivor01", "Menu_25", "Survivor01_Completed", 99));
            levelInfos.Add(new LevelInfo("Siege01", "GUI\\Shell\\level_icons\\map_seige01", "Siege01_65", "Siege01_Completed", 99));
            levelInfos.Add(new LevelInfo("Shrine01", "GUI\\Shell\\level_icons\\map_shrine01", "Menu_57", "Shrine01_Completed", 99));
            levelInfos.Add(new LevelInfo("Challenge04", "GUI\\Shell\\level_icons\\map_challenge04", "Challenge04_19", "Challenge04_Completed", 99));
            levelInfos.Add(new LevelInfo("Challenge02", "GUI\\Shell\\level_icons\\map_challenge02", "Challenge02_24", "Challenge02_Completed", 99));
            levelInfos.Add(new LevelInfo("Challenge07", "GUI\\Shell\\level_icons\\map_challenge07", "Challenge07_20", "Challenge07_Completed", 99));
            levelInfos.Add(new LevelInfo("Moving01", "GUI\\Shell\\level_icons\\map_moving01", "Moving01_71", "Moving01_Completed", 99));
            levelInfos.Add(new LevelInfo("Survivor02", "GUI\\Shell\\level_icons\\map_survivor02", "ProtoTown03_144", "Survivor02_Completed", 99));
            levelInfos.Add(new LevelInfo("Crossroads02", "GUI\\Shell\\level_icons\\map_crossroads02", "Menu_58", "Crossroads02_Completed", 99));
            levelInfos.Add(new LevelInfo("Scenes02", "GUI\\Shell\\level_icons\\map_scenes01", "Menu_61", "Scenes02_Completed", 99));
            levelInfos.Add(new LevelInfo("Hunt01", "GUI\\Shell\\level_icons\\map_hunt01", "Menu_60", "Hunt01_Completed", 99));
            levelInfos.Add(new LevelInfo("Challenge10", "GUI\\Shell\\level_icons\\map_challenge10", "ProtoTown03_116", "Challenge10_Completed", 99));
            levelInfos.Add(new LevelInfo("Challenge09", "GUI\\Shell\\level_icons\\map_challenge09", "ProtoTown03_118", "Challenge09_Completed", 99));
            levelInfos.Add(new LevelInfo("Platforms01", "GUI\\Shell\\level_icons\\map_platforms01", "Menu_62", "Platforms01_Completed", 99));
            levelInfos.Add(new LevelInfo("Challenge05", "GUI\\Shell\\level_icons\\map_challenge05", "ProtoTown03_108", "Challenge05_Completed", 99));
            levelInfos.Add(new LevelInfo("Scorched01", "GUI\\Shell\\level_icons\\map_scorched01", "ProtoTown03_73", "Scorched01_Completed", 99)); 
            levelInfos.Add(new LevelInfo("Challenge08", "GUI\\Shell\\level_icons\\map_challenge08", "ProtoTown03_120", "Challenge08_Completed", 99));
            levelInfos.Add(new LevelInfo("Fortress01", "GUI\\Shell\\level_icons\\map_fortress01", "ProtoTown03_67", "Fortress01_Completed", 99));
            levelInfos.Add(new LevelInfo("Challenge11", "GUI\\Shell\\level_icons\\map_challenge11", "ProtoTown03_117", "Challenge11_Completed", 99));
            levelInfos.Add(new LevelInfo("Gauntlet01", "GUI\\Shell\\level_icons\\map_gauntlet01", "ProtoTown03_74", "Gauntlet01_Completed", 99));
            levelInfos.Add(new LevelInfo("Voyage01", "GUI\\Shell\\level_icons\\map_voyage01", "ProtoTown03_236", "Voyage01_Completed", 99));
            levelInfos.Add(new LevelInfo("Rescue01", "GUI\\Shell\\level_icons\\map_rescue01", "ProtoTown03_159", "Rescue01_Completed", 99));
            levelInfos.Add(new LevelInfo("Challenge12", "GUI\\Shell\\level_icons\\map_challenge12", "ProtoTown03_119", "Challenge12_Completed", 99));
            levelInfos.Add(new LevelInfo("FinalArena01", "GUI\\Shell\\level_icons\\map_finalArena01", "ProtoTown03_101", "", 99));
        ...
        public void RandomizeLevelOrder(Random rand, string path)
        {
            ...
            SetMapValues(doc, newOrder);
            doc.Save(path + "/Content/Game/MapLayouts.xml");

            EditLevelScripts(path);
        }

        void SetMapValues(XmlDocument doc, int[] order)
        {
        ...
        private void EditLevelScripts(string path)
        {
            // Rippling Walls
